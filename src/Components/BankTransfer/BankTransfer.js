...
const BankTransfer = ({ setPage, onNotify, user, refreshPage })=>{
                ...
                <div className="overlay">
                    ...
                    <form className="form" onSubmit={handleSubmit(onSubmitRequest)}>
                        ...
                        <div className="input-wrapper">
                            ...
                            /><br/>
                            {errors.bankName && <h6 className = 'vError'>{errors.bankName.message}</h6>}
                        </div>
                        <div className="input-wrapper">
                            <input 
                                className="input" 
                                ...
                                name="accountName"
                                {...register('accountName', { required: 'Account Name Code is required' })}
                            /><br/>
                            {errors.accountName && <h6 className = 'vError'>{errors.accountName.message}</h6>}
                        </div>
                        <div className="input-wrapper">
                            <input 
                                className="input" 
                            ...
                            /><br/>
                            {errors.accountNumber && <h6 className = 'vError'>{errors.accountNumber.message}</h6>}
                        </div>
