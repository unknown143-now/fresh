...
const Navigation = ({ page, dashpage, adminDashPage, logOut, logAdminOut, amount })=>{
                ...
                <div className="nav-list">
                    {
                        ...
                        <div className="nav-row">
                            ...
                            <Link className={`list ${dashpage === 'Transactions'? 'active': ''}`} to="/dashboard/transactions">Transactions</Link>
                            ...
                            <Link to="/dashboard/transactions" className="list cash"> <Wallet className="img"/>{`$${amount}`}</Link>
                        </div>
                    }
                    {
                    ...
                    }
                    {
                        ...
                        <div className="nav-row">
                            <Link className="list" to="/">Home</Link>
                            <Link className={`list ${adminDashPage === 'AdminDashboard'? 'active': ''}`} to="/admin/dashboard">Admin Dashboard</Link>
                            <Link className={`list ${adminDashPage === 'Withdrawals'? 'active': ''}`} to="/admin/Withdrawals">Users Withdrawal</Link>
                            <span
                                className="list" 
