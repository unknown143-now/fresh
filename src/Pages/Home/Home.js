        ...
        <div className="Home">
            ...
            <section className="pay">
                <div className="payment">
                    ...
                    <div className="text3">
                        <p>
                            Note: After Registration, Login won't be possible 
                            until an Admin grants access. To gain access, 
                            Send a Proof of payment to the company's Email, 
                            to confirm Payment:- 
                            <a href="mailto:proinvestment.supp@gmail.com" className="mail">proinvestment.supp@gmail.com</a>
                        </p>
                    </div>
                </div>
            </section>
            <section className="fourth-section">
                <div className="overlay">
                    ...
                    <p style={{"paddingBottom": "10px"}}><strong>ROI:-</strong>Investors Recieves a certain daily return which sums up to the Monthly payment (capital + ROI) at the end of The 30 days. </p>
                    <p style={{"paddingBottom": "10px"}}><strong>Duration:-</strong> 30 Days, Withdrawal can be done everyday. Daily Returns is Delivered after every Successful Login.</p>
                    <p style={{"paddingBottom": "10px"}}><strong>Referral:-</strong> For Every Successful Referral, Investors get $50 bonus </p>

                    <div className="second-sub-div">
                        <div className="small-box">
                            <p className="p1">01.</p>
                            <h1 className="h1"><span className="span">- </span> Level 1</h1>
                            <p className="p2">Minimum Investment of <strong>$500 - $1000</strong>, Investors will Earn an ROI of 30% at the end of the month. </p>
                        </div>
                        <div className="small-box">
                            <p className="p1">02.</p>
                            <h1 className="h1"><span className="span">- </span> Level 2</h1>
                            <p className="p2">Minimum Investment of <strong>$1100 - $2000</strong>, Investors will Earn an ROI of 40% at the end of the month. </p>
                        </div>
                        <div className="small-box">
                            <p className="p1">03.</p>
                            <h1 className="h1"><span className="span">- </span> Level 3</h1>
                            <p className="p2">Minimum Investment of <strong>$2100 - $3000</strong>, Investors will Earn an ROI of 60% at the end of the month. </p>
                        </div>
                        <div className="small-box">
                            <p className="p1">04.</p>
                            <h1 className="h1"><span className="span">- </span> Level 4</h1>
                            <p className="p2">Minimum Investment of <strong>$3100 - unlimited</strong>, Investors will Earn an ROI of 80% at the end of the month. </p>
                        </div>
