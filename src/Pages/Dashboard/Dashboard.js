            ...
            case "NORMAL":
                return(
                    <div className="activecard-wrapper">
                        <span>CARD: </span><img className="activecard" src={normalCard} alt=""/>
                    </div>
                )
            case "CLASSIC":
                return(
                    <div className="activecard-wrapper">
                        <span>CARD: </span><img className="activecard" src={classicCard}alt=""/>
                    </div>
                )
            case "MERCHANT":
                return(
                    <div className="activecard-wrapper">
                        <span>CARD: </span><img className="activecard" src={merchantCard} alt=""/>
                    </div>
                )
            case "ELITE":
                return(
                    <div className="activecard-wrapper">
                        <span>CARD: </span><img className="activecard" src={eliteCard} alt=""/>
                    </div>
                )
            default:
                return(
            ...
            <section className="dashboard-one">
                <div className="left">
                    <div className="first">
                        ...
                        <p className="p-tag">Referers : <span>{userDetails.referrals}</span></p>
                        <Link className="a-tag" to="/dashboard/transactions">VIEW ALL</Link>
                    </div>
